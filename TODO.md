...
2. [x] Нормальное удаление обоев + закрытие обоины в галерее (десктоп)
3. [x] Удалить кнопку "Очистить" в настройках (не работает)
4. [ ] ПКМ меню в настройках докбара для удаления (сейчас просто confirm)
5. [ ] После добавления сайта в докбар - неправильная иконка (показать пример)
