...
export default function SiteModal({
  ...
  const modalRef = useClickOutside(() => setShowSiteModal(false));
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                className="text-sm p-2 bg-slate-100 dark:bg-dark-800 rounded-lg text-black dark:text-white font-medium hover:bg-slate-200 dark:hover:bg-dark-700 transition-colors"
                onClick={() => {
